...
const fcAccountId = '<AccountId>';
const fcRegion = '<Region>';
const fcServiceName = '<ServiceName>';
const sessionFunctionName = '<SessionFunctionName>';
const dbFunctionName = '<DBFunctionName>';
